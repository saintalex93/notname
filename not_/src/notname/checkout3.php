                    ...
                    <div class="card">
                        <form method="post" action="checkout4.php">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li class="disabled checkout1"><a href="#"><i class="fas fa-truck"></i><br>Método de Entrega</a>
                                </li>
                                <li class="active checkout1"><a href="#"><i class="far fa-money-bill-alt"></i><br>Método de pagamento</a>
                                </li>
