...
PRODUTO_tsCRIACAO DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
)ENGINE = INNODB;
...
MODELO_tsCRIACAO DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO MARCA (MARCA_cDESC,MARCA_nSTATUS) VALUES ('NIKE','Ativo'),('ADIDAS','Ativo');

INSERT INTO CATEGORIA (CATEGORIA_cDESC,CATEGORIA_cSTATUS) VALUES ('Masculino','Ativo'),('Feminino','Ativo'),('Infantil','Ativo'),('Lançamentos','Ativo');

INSERT INTO CATEGORIA VALUES (0, 'Peita Periculosa', 'Ativo', 1), (0, 'Raba Devastadora', 'Ativo',2);

INSERT INTO PRODUTO (PRODUTO_cDESC, PRODUTO_cDESCCOMPLETA, PRODUTO_cSTATUS, MARCA_nID) VALUES ('HIFONE CINZA ESPACIAL','Para mudar de opinião sobre a lambiscada','Ativo',2);

INSERT INTO PRODUTO_CATEGORIA (CATEGORIA_nID, PRODUTO_nID) VALUES (2,1);
INSERT INTO PRODUTO_CATEGORIA (CATEGORIA_nID, PRODUTO_nID) VALUES (6,1);
...
select *,
 ...
 SELECT COR.COR_nID, COR_cDESC, COR_cHEX, COUNT(COR.COR_nID) AS QUANTIDADE FROM COR INNER JOIN MODELO ON COR.COR_nID = MODELO.COR_nID group by COR.COR_nID, COR_cDESC, COR_cHEX;
