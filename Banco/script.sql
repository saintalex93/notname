...
CLI_COMPRA_nID BIGINT PRIMARY KEY AUTO_INCREMENT,
CLI_nCOD BIGINT,
COMPRA_nID BIGINT,
...
CREATE TABLE COMPRA (
COMPRA_nID BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE MODELO (
MODELO_nID BIGINT PRIMARY KEY AUTO_INCREMENT,
...
COMPRA_ESTOQUE_nID BIGINT PRIMARY KEY AUTO_INCREMENT,
COMPRA_ESTOQUE_nVALORTOTAL DOUBLE(8,2),
COMPRA_ESTOQUE_dDATA DATE
)ENGINE = INNODB;

CREATE TABLE MODELO_COMPRA_ESTOQUE (
MOD_COMP_ESTOQUE_nID BIGINT PRIMARY KEY AUTO_INCREMENT,
...
COMP_STA_nID BIGINT PRIMARY KEY AUTO_INCREMENT,
STATUS_nID INT,
COMPRA_nID BIGINT,
