                ...
                <div class="card">
                    <form method="post" action="checkout2.php">
                        ...
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li class="disabled checkout1"><a href="#"style="cursor:no-drop;><i class="fas fa-truck"></i><br>Método de Entrega</a>
                            </li>
                            <li class="disabled checkout1"><a href="#"style="cursor:no-drop;><i class="far fa-money-bill-alt"></i><br>Método de pagamento</a>
                            </li>
                            <li class="disabled checkout1"><a href="#"style="cursor:no-drop;><i class="fas fa-eye"></i><br>Revisão da encomenda</a>
                            </li>
                        </ul>
