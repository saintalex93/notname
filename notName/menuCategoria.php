	...
	<div class="card card-default sidebar-menu">
		...
		<div class="card-body">
			<ul class="nav nav-pills flex-column category-menu">
				<li><a href="category.html">Camisetas <span
						class="badge pull-right badge-primary badge-pill">42</span></a>
					<ul>
						<li class="text-black"><a href="">Series</a></li>
						<li class="text-black"><a href="">Amarola</a></li>
						<li class="text-black"><a href="">Believe</a></li>
						<li class="text-black"><a href="">Bela Recatada e do Lar</a></li>
					</ul></li>
