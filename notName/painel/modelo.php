        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="cameraCapaModelo col-12 text-center border-white" onclick="document.all.capaInput.click();">
                    ...
                    <img name = "imageEstbl" src="images/logoNot.png"  class="NO-CACHE col-12" id = "capaImg" onerror='this.src="images/logoNot.png"'>
                </div>
            </div>
            ...
            for ($i=1; $i <=3 ; $i++) { 
                ...
                echo '
                <div class="cameraModeloFoto'.$i.' cameraModelo col-12 border-white" onclick="document.all.foto'.$i. '.click(); "> <img name = "imageEstbl" src="images/logoNot.png"  class="col-12 foto NO-CACHE" id = "foto'.$i.'Img" onerror=\'this.src="images/logoNot.png"\') ></div><br>
