...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 ofertaDoDia animated fadeInDown">
                    <a href="#" class="btn btn-success btn-sm animated bounce">Oferta do dia</a> <a href="#">Obtenha um desconto de 25% em pedidos acima de R$ 200! </a>
                </div>
    ...
    <div class="container">
        ...
        <nav class="navbar navbar-expand-lg navbar-light caixaNav">
            <a class="navbar-brand logo" href="index.php"><img src="assets/logo.png" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="">Camisetas</a>
                    <div class="dropdown-menu">
                            <a class="dropdown-item" href="">Series </a>
                            
                            <a class="dropdown-item" href="">Amarola</a>

                            <a class="dropdown-item" href="">Believe</a>

                            <a class="dropdown-item" href="">Bela Recatada e do Lar</a>
                        </div>

                    </li>


                     <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="">Pirralhos</a>
                        <div class="dropdown-menu">
                     ...
                     <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="">Acessórios</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="">produto 1</a>
                ...
                <div class="navbar-buttons col">
                    ...
                    <div class="navbar-collapse collapse right ">
                        <a href="carrinho.php" class="btn  navbar-btn"><i class="fas fa-shopping-cart"></i><span class="hidden-sm"> itens no carrinho</span></a>
                    </div>
                    <!--/.nav-collapse -->
