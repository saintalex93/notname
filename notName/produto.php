...
foreach ($modelo as $m) {
    ...
    $arrModelo[] = array("ID" => $m->getIdModelo(), "NOME_MODELO" => $m->getNomeModelo(), "VALOR_MODELO" => $m->getVlrVendaModelo(), "ID_COR" => $m->getCormodelo(), "DESC_COR" => $m->getDescCor(), "HEX_COR" =>$m->getHexCor(), "ID_TAMANHO" => $m->getTamanhoModelo(), "DESC_TAMANHO" => $m->getDescTamanho());
                    ...
                    <div class="col-sm-12 col-md-12 mb-3 d-flex flex-row flex-column">
                        <div class="card ">
                            <div class="card-body text-center">
                                ...
                                <p class="price"><?php echo "R$ ". number_format($arrModelo[$indice_array]['VALOR_MODELO'], 2, ',', '.');?></p>
                                <p class="buttons">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="container border col-md-6 text-center pb-0">
                            ...
                            foreach ($arrModelo as $arM) {
                             ...
                             <button class='btn btn-primary' style = 'background: $arM[HEX_COR]; color: $arM[HEX_COR]'>P</button>
                     ...
                     <div class="container border col-md-6 text-center pb-0">
                          ...
                          <?php 
                            ...
                            foreach ($arrModelo as $arM) {
                             ...
                             <button class = 'btn btn-secondary corProd'>$arM[DESC_TAMANHO]</button>
